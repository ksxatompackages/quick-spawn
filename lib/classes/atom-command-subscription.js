...
function AtomCommandSubscription (descriptor, derived, resource) {
  ...
  registerAtomKeybinding(atomKeybinding, atomCmd, atomTarget)
  registerAtomMenuBar(atomMenuBar, atomCmd)
  registerAtomContextMenu(atomContextMenu, atomCmd, atomTarget)
  return out
}
