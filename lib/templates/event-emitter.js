...
const applyEventListenerSubscription = applyInstance([EventListenerSubscription])
const {assign} = Object
const {iterator} = Symbol

const getevtsub = (self, disposalact) =>
  applyEventListenerSubscription(self, {disposalact})
